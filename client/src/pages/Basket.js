...
const Basket = observer(() => {
    ...
    // ----- Рахуєм общу сумму, яку користувач набрав в корзину ------- //
    let prices = 0;
    ...
    return (
        ...
        >
            ...
            <Card className="d-flex flex-row  p-2 justify-content-between align-items-center mb-2">
                <h1 className="pr-2">Підсумки: </h1>
                <h3 className="pl-2">{prices}<span className="font-weight-light pl-2"> гривень</span></h3>
            </Card>
